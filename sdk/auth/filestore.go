...
func (s *FileTokenStore) resolveDeletePath(ctx context.Context, id string) (string, error) {
...
func (s *FileTokenStore) lookupPathByAuthID(ctx context.Context, baseDir string, id string) (string, bool) {
