...
var logFieldOrder = []string{"provider", "model", "previous_auth_id", "selected_auth_id", "selection_attempt", "request_retry", "selection_snapshot", "mode", "budget", "level", "original_mode", "original_value", "min", "max", "clamped_to", "error"}
