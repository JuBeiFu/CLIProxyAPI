...
func NewHandler(cfg *config.Config, configFilePath string, manager *coreauth.Manager) *Handler {
	...
	h := &Handler{
		...
		proxyStats:          proxystats.DefaultStore(),
...
// SetProxyStatistics allows replacing the proxy statistics reference.
func (h *Handler) SetProxyStatistics(stats *proxystats.Store) { h.proxyStats = stats }
